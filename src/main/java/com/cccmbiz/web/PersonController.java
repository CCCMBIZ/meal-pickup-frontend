...
public class PersonController {
    ...
    public @ResponseBody
    Optional<Person> getPerson(@PathVariable("id") int personId) {
    ...
    public @ResponseBody
    Person createEmployee(@RequestBody Person emp) {
    ...
    public @ResponseBody
    Person deleteEmployee(@PathVariable("id") int personId) {
